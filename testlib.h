...
const char *latestFeatures[] = {
        ...
        "Reformatted",
        "Use setTestCase(y2) or unsetTestCase() to support test cases (you can use it in any type of program: generator, interactor, validator or checker)",
...
"euc-cn", "euc-tw", "koi8-mod", "koi8-u", "tis-620", "ibm437", "ibm850", "ibm852", "ibm855", "ibm857",
